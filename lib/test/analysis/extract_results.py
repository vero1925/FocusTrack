...
def extract_results(trackers, dataset, report_name, skip_missing_seq=False, plot_bin_gap=0.05,
    ...
    for seq_id, seq in enumerate(tqdm(dataset)):
        ...
        for trk_id, trk in enumerate(trackers):
            # Load results
            if report_name in ["got10k_test", "got10k_val", "got10k_ltrval"]:
                report_name = "got10k"
            if report_name in ["antiuav410_test", "antiuav410_val", "antiuav410_ltrval"]:
                report_name = "antiuav410"
            ...
            err_overlap_all.append(err_overlap.view(1, -1)) 
