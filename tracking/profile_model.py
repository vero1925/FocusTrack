...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='focustrack', choices=['focustrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='focustrack_single', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    '''set some values'''
    bs = 1
    z_sz = cfg.TEST.TEMPLATE.SIZE
    x_sz = cfg.TEST.SEARCH.SIZE

    if args.script == "focustrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_focustrack
