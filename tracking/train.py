...
def parse_args():
    ...
    # parser.add_argument('--rdzv_endpoint', type=str, help="port number -> host:port")  # specify when mode is multiple
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = f"OMP_NUM_THREADS=1 torchrun --standalone --nnodes=1 --nproc_per_node %d  \
